...
public class GatewayServer {
    ...
    private static class Handler extends Thread {
        ...
        /**
         * This method contains all the activities that the database thread needs to perform
         * while it is connected to the system. It contains an infinite while
        ...
        public void user(int id) throws IOException {
            ...
            while (true) {
                ...
                /* if User is away and there was motion detected and unknown person entered the house */
        ...
        /**
         * In this method the client device connected to this server
         * submits their timestamp, the difference between the client clock
         * and the gateway clock are stored to be sent so each client can reset their clock
         * If an offset needs to be sent to the client it is sent from here
         * 
         * @param String input
         * @param int    id
         */
        ...
        /**
         * This method will send each of the clients the offset they need
         * to reset their clock or their timestamp. Copies of hashmaps are used
         * to iterate through values while changing other values. This method
         * can be called once every second or longer to maintain offset accuracy
         * 
         * @param int id
         */
        private void sendAllOffSets() {
            Boolean offset = true;
            double temp = 0.0;
            /* temporary copy of the offsetWasSet hashmap so one copy can be
            read while the original is being updated*/
            ...
            if (offset) {
                ...
                int counter = 0;
                /* for all values in the copy of all offsets, calculate
                the offset */
                ...
                /* make a copy of send offset so this one can be used while
                the other is being edited */
