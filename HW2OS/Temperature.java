...
public class Temperature {
    ...
    //the amount that this slave node's time is offset from the master nodes time in seconds
            ...
            try {
                ...
                if (input != null) {
                    ...
                    if (input.contains(".")) {
                        ...
                        out.println(getTime(timeOffset) + ", " + type + " " + name + " with ID: " + myID + " has status "
                                + currentTemp);
                    }
                } else {
