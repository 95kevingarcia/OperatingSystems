...
/*
 * the following are for getting system time and sending
...
public class Sensor {
    ...
    private static final String GATEWAY_IP = "10.108.105.186"; // Kierstins at
    // Kierstins
    ...
    public static void connect() throws IOException {
        String type = "sensorServer";
        String name = "userSensor";
        out.println(type);
        out.println(name);
        String input = "";
        ...
        System.out.println("Sensor Server Successfully connected to Gateway Server with ID " + id);

        while (true) {
            input = in.readLine();
            if (input != null && input.equalsIgnoreCase("sensor")) {
                System.out.println("creating new sensor");
                new Handler().start();
                System.out.println("after new handler");
            }
        }
    }
    ...
    private static class Handler extends Thread {
        ...
        private static final String ip = "10.108.105.186"; // Kierstins at
        // Kierstins
        // socket constructor takes port as int
        private static final int port = 8080;
        ...
        public static void runConnection() throws IOException {
                ...
                try {
                    ...
                    if (in.ready()) {
                        ...
                        if (input.contains(".")) {
                            ...
                            System.out.println("query print with id: " + id);
                        ...
                        if (movement != motion) {
                            ...
                            out.println(id);
                            out.println(movement);
                            System.out.println("print number 2 with id: " + id);
                            out.println(getTime(timeOffset) + ", " + type + " " + name + " with ID: " + id
                                    + " has status " + movement);
            ...
            stopConnection();
            System.out.println("id " + id + " Disconnected from Gateway Server");
        }
    }
